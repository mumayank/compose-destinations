...
internal class SingleNavGraphWriter(
    ...
    private fun navGraphDestinationsCode(
        ...
        importedDestinations: List<ImportedRoute.Destination>,
    ): String {
    ...
    private fun nestedNavGraphsCode(
        ...
        importedNestedGraphs: List<ImportedRoute.NavGraph>
    ): String {
    ...
    private fun ImportedRoute.Destination.importedDestinationCode(): String {
    ...
    private fun ImportedRoute.NavGraph.importedNavGraphCode(): String {
        if (additionalDeepLinks.isEmpty() && overriddenDefaultTransitions is ImportedRoute.NavGraph.OverrideDefaultTransitions.NoOverride) {
            return importableHelper.addAndGetPlaceholder(generatedType)
        }
        ...
        return StringBuilder().apply {
            ...
            if (overriddenDefaultTransitions is ImportedRoute.NavGraph.OverrideDefaultTransitions.Override) {
